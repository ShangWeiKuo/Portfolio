...
mainPanel(h3(renderText(paste0(result()$accuracy, "%")), style="color:red; font-weight:bold; text-align:center; margin:0px;"))
```

### **AUC**
```{r}
mainPanel(h3(renderText(paste0(result()$AUC, "%")), style="color:red; font-weight:bold; text-align:center;  margin:0px;"))
```

### **精準率(Precision)**
```{r}
mainPanel(h3(renderText(paste0(result()$Precision_rate, "%")), style="color:red; font-weight:bold; text-align:center;  margin:0px;"))
```

### **召回率(Recall)**
```{r}
mainPanel(h3(renderText(paste0(result()$Recall_Sen_rate, "%")), style="color:red; font-weight:bold; text-align:center;  margin:0px;"))
```

### **F1-score**
```{r}
mainPanel(h3(renderText(paste0(result()$F1, "%")), style="color:red; font-weight:bold; text-align:center;  margin:0px;"))
```
